            ...
            <section class="rounded-lg border">
                ...
                <ul class="max-h-[60vh] overflow-y-auto">
                    <li
                        ...
                        :class="
                            g.groupCode === selectedGroupCode ? 'bg-accent' : 'hover:bg-accent/40'
                        "
                    >
                        <button class="min-w-0 flex-1 text-left" @click="selectGroup(g.groupCode)">
                            <div class="flex items-center gap-1.5">
                                <span class="truncate text-sm font-medium">{{ g.groupName }}</span>
        ...
        <AlertDialog v-model:open="groupDeleteOpen">
            <AlertDialogContent>
                <AlertDialogHeader>
                    ...
                    <AlertDialogDescription>
                        "{{ groupDeleteTarget?.groupName }}" 그룹을 삭제합니다. 하위 코드가 있으면
                        삭제되지 않습니다.
                    </AlertDialogDescription>
                </AlertDialogHeader>
                <AlertDialogFooter>
